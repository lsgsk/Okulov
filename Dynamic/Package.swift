...
let package = Package(
	...
	products: [
		...
		.executable(name: "C2.4", targets: ["C2.4"]),
		...
		.executable(name: "E1.11", targets: ["E1.11"]),
	],
	targets: [
		.target(name: "Matrix"),
		...
		.executableTarget(name: "C2.4", dependencies: ["SimpleMatrix"], path: "Sources/2/C2.4"),
		...
		.executableTarget(name: "E1.11", dependencies: ["SimpleMatrix"], path: "Sources/1/E1.11"),
